...
class CandidateAppliedPositions extends Component {
                                        ...
                                        this.state.users.map(
                                            vacancy =>
                                                <tr key={vacancy.uuid}>
                                                    ...
                                                    <td>{vacancy.profile.role}</td>
                                                    <td>{vacancy.profile.description}</td>
                                                    <td>{vacancy.profile.locationOfEmployment}</td>
                                                    <td>{vacancy.profile.modeOfEmployment}</td>
                                                </tr>
                                        )
                                    }
...
export default CandidateAppliedPositions;