...
class AdminViewAllJobSeekers extends Component {
    ...
    loadData() {
        ...
        AuthenticationDataService.getAllStudents().
            then(response => {
            ...
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            <br />
                            <h3 style={{ textAlign: "center" }}>All Job Seeker Profiles</h3>
                        </div>
                    </div>
                    <div className="row">
...
export default AdminViewAllJobSeekers;