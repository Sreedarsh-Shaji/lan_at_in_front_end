...
import CandidateSeeProfile from "../CandidateComponents/CandidateSeeProfile";
import CandidateSeeSelected from "../CandidateComponents/CandidateSeeSelected";
import UpgradeProfile from "../StudentComponents/UpgradeProfile";
      ...
      <div>
        <Router>
          <Switch>
            ...
            <Route
              path="/Company/ApplicantDetail/:mail"
              component={ApplicantProfile}
            />
            <Route
              path="/Company/Applciation/invite-for-intervire:data"
              component={InviteForInterview}
            />
            <Route
              path="/Company/Applciation/get-interview-list"
              component={GetInterviewList}
            />
            ...
            <Route
              path="/Candidate/VacancyDetails"
              component={CandidateVacancies}
            />
            <Route
              path="/Candidate/see-a-vacancy/:id"
              component={CandidateVacancyDetails}
            />
            <Route
              path="/Candidate/see-applied-positions"
              component={CandidateAppliedPositions}
            />
            <Route
              path="/Candidate/see-interview-invites"
              component={CandidateViewInterviewInvites}
            />
            <Route
              path="/Candidate/see-profile"
              component={CandidateSeeProfile}
            />
            <Route
            ...
            />
            <Route
              path="/Candidate/see-selected"
              component={CandidateSeeSelected}
            />
            ...
            <Route
              path="/Recruiter/applicant-list"
              component={RecruiterGetApplicantList}
            />
            <Route
              path="/Recruiter/interview-schedules"
              component={RecruiterSeeInterviewSchedule}
            />

            {/* Admin components */}
            <Route path="/Admin/Home" component={HomePage} />
            <Route
              path="/Admin/View-all-companies"
              component={AdminViewCompanies}
            />
            <Route
              path="/Admin/View-all-recruiters"
              component={AdminViewRecruiters}
            />
            <Route
              path="/Admin/View-all-vacancies"
              component={AdminViewVacancies}
            />
            <Route
              path="/Admin/View-all-job-seekers"
              component={AdminViewAllJobSeekers}
            />
            <Route
              path="/Admin/View-all-companies"
              component={AdminViewCompanies}
            />
            <Route
              path="/Admin/add-career-path"
              component={AdminAddCareerPath}
            />
            <Route path="/Admin/view-career-path" component={AdminCareerPath} />

            {/* Student components*/}
            <Route path="/Student/Home" component={StudentHome} />
            <Route path="/Student/Career-path" component={GetCareerPath} />
            <Route
              path="/Student/see-career-path"
              component={SeeSavedCareerPaths}
            />
            <Route
              path="/Student/upgarade-profile"
