...
class RecruiterGetApplicantList extends Component {
    ...
    loadData() {
        ...
        AuthenticationDataService.getAllApplicants().
            then(response => {
            ...
            <div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            <br />
                            <h3 style={{ textAlign: "center" }}>Applicant List</h3>
                        </div>
                    </div>
                    <div className="row">
                                            ...
                                            .map(
                                                app =>
                                                    <tr key={app.uuid}>
                                                        ...
                                                        <td>{app.profile.role}</td>
                                                        <td><button className="btn btn-primary" onClick={() => this.viewIndividualProfile(app.jobseeker.email)}>See<br />Candidate</button></td>
                                                        <td><button className="btn btn-success" onClick={() => this.sendInvite(app)}>Schedule<br />Interview</button></td>
                                                    </tr>
...
export default RecruiterGetApplicantList;